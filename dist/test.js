...
import { getAssociatedTokenAddress } from './token/utils.js';
import { getConnection } from './utils/connection/index.js';
import { getServerKeypair } from './utils/keys/index.js';
...
const USER_ADDRESS = new PublicKey('FeuT9mmNGSDxaUVSMPLxbGhybh8i3mjUGKhpnXHuzyCe');
const MINT_ADDRESS = new PublicKey('3g1kGZL66m65ooeYZxKGazkkbHsCWqu38WEsgvGDbB1Y');
...
const associatedAddress = await getAssociatedTokenAddress(USER_ADDRESS, MINT_ADDRESS);
